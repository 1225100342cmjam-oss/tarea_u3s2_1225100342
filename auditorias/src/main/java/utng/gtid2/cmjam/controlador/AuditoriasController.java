...
import utng.gtid2.cmjam.dao.AuditorDAO;
import utng.gtid2.cmjam.dao.EmpresaDAO;
import utng.gtid2.cmjam.modelo.Auditoria;
import utng.gtid2.cmjam.modelo.Auditor;
import utng.gtid2.cmjam.modelo.Empresa;
...
public class AuditoriasController {
    ...
    public void initialize() {
        ...
        colFechaInicio.setCellValueFactory(cellData -> {
            LocalDate f = cellData.getValue().getFechaInicio();
    ...
    public void cancelarAuditoria() {
        ...
        try {
            auditoriaDAO.actualizarEstatus(seleccionada.getIdAuditoria(), "Cancelada", seleccionada.getFechaFin());
            cargarAuditorias();
        } catch (SQLException e) {
