...
public class EmpresasController {
    ...
    private void cargarEmpresas() {
        try {
            ObservableList<Empresa> datos = FXCollections.observableArrayList(empresaDAO.listarTodas());
    ...
    public void guardarEmpresa() {
        ...
        try {
            Empresa e = (empresaSeleccionada != null) ? empresaSeleccionada : new Empresa();
