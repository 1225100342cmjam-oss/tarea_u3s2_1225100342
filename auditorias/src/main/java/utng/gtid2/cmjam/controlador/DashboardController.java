package utng.gtid2.cmjam.controlador;
...
import utng.gtid2.cmjam.dao.AuditoriaDAO;
import utng.gtid2.cmjam.dao.EvaluacionDAO;
import utng.gtid2.cmjam.dao.HallazgoDAO;
import utng.gtid2.cmjam.dao.PlanAccionDAO;
import utng.gtid2.cmjam.modelo.Auditoria;
...
import utng.gtid2.cmjam.reportes.ReporteExcel;
import utng.gtid2.cmjam.reportes.ReportePDF;
import utng.gtid2.cmjam.reportes.ReporteWord;
import utng.gtid2.cmjam.util.GraficasUtil;
...
public class DashboardController {
    ...
    public void actualizarDashboard() {
        ...
        try {
            ...
            resumen.forEach((estado, total) ->
                    pieCumplimiento.getData().add(new PieChart.Data(estado + " (" + total + ")", total)));
    ...
    public void generarReportePDF() {
        ...
        try {
            ...
            new ReportePDF().generar(destino.getAbsolutePath(),
    ...
    public void generarReporteExcel() {
        ...
        try {
            ...
            new ReporteExcel().generar(destino.getAbsolutePath(),
                    datos.empresa, datos.evaluaciones, datos.porCategoria);
    ...
    /** Exporta la gráfica actual del dashboard a un PNG temporal, para incrustarla en PDF/Word. */
